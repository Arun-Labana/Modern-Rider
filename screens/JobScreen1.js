...
const JobScreen1 = () => {
  ...
  return (
    <SafeAreaView style={tw`bg-white -mt-5 flex-grow`}>
        <View>
            <Text style={tw`text-center  py-20 text-xl`}>Please pick user from any of these</Text>
      </View>
      <FlatList
       data = {data}
       ...
       renderItem={({item : {id, title , multiplier , image , travel_time , price}, item}) => (
        ...
        onPress={() => {
            setSelected(item)
            navigation.navigate("JobScreen2");
        }}
         ...
         >
            ...
            <View style={tw`-ml-6`}>
                ...
                <Text style={tw`text-lg`}>Source</Text>
            </View>
